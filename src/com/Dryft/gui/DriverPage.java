...
public class DriverPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setText("" + new java.text.DecimalFormat("#.#").format(rating));

        jLabel7.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jLabel7.setText("Trip Duration");

        jTextField6.setEditable(false);
        jTextField6.setFont(new java.awt.Font("SansSerif", 0, 14)); // NOI18N
        jTextField6.setText("" + Ride.calculateDriverTime(source, driver));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Ride ride = null;
        try {
            ride = user.bookRide(driver, source, dest);
        ...
        new timerPage(ride).setVisible(true);
        this.dispose();
