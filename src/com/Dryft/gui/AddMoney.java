...
public class AddMoney extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Rs " + this.balance);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        new Home(this.user).setVisible(true);        // TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (moneyToAdd >= 300 - balance) {
            try {
                user.incrementBalance(moneyToAdd);
